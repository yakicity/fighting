...
class Fighter:
    ...
    def __init__(self, size, gravity, move_speed,jump_speed,position,direction,color):
        """
        ...
        self.rigit_time_amount_to_enemy = 15
        self.rigit_time_amount = 20
    ...
    def figure(self):
        ...
        pygame.draw.rect(main.SURFACE, self.color, rect)
    ...
    def controlrandom(self):
        ...
        rand_action = np.random.choice([0,1,2], 1)[0]
    ...
    def character_action(self, enemy):
        ...
        if self.action[0]:
            ...
            radius = 30
            pygame.draw.circle(main.SURFACE, (0, 0, 200), circle_pos, radius)
    ...
    def life(self, view,color):
        ...
        if view == "left":
            ...
            pygame.draw.rect(main.SURFACE, color, (35 + self.damage, 25, 390 - self.damage, 20))
            ...
            pygame.draw.rect(main.SURFACE, color, (575, 25, 390 - self.damage, 20))
